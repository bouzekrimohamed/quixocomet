    ...
    public static class VisualThemeCatalog
    {
        ...
        private static GameplayPalette MarineBlue()
        {
            return new GameplayPalette(
                new Color(0.60f, 0.63f, 0.68f, 1f),
                new Color(0.045f, 0.075f, 0.13f, 1f),
                new Color(0.045f, 0.075f, 0.13f, 1f),
                new Color(0.92f, 0.86f, 0.72f, 0.94f),
                new Color(0.74f, 0.55f, 0.31f, 1f),
                new Color(0.39f, 0.24f, 0.12f, 1f),
                new Color(0.93f, 0.88f, 0.74f, 1f),
                new Color(0.98f, 0.94f, 0.82f, 1f),
                new Color(1.00f, 0.91f, 0.56f, 1f),
                new Color(0.16f, 0.42f, 0.68f, 1f),
                new Color(0.02f, 0.12f, 0.28f, 1f),
                new Color(0.78f, 0.25f, 0.13f, 1f),
                new Color(0.06f, 0.12f, 0.21f, 0.78f),
                new Color(0.08f, 0.19f, 0.34f, 0.95f),
                new Color(0.72f, 0.53f, 0.29f, 0.95f),
                new Color(0.12f, 0.17f, 0.23f, 0.38f),
        ...
        private static GameplayPalette EmeraldGreen()
        {
            return new GameplayPalette(
                ...
                new Color(0.045f, 0.11f, 0.095f, 1f),
                new Color(0.045f, 0.11f, 0.095f, 1f),
                new Color(0.88f, 0.86f, 0.70f, 0.94f),
                new Color(0.72f, 0.53f, 0.30f, 1f),
                new Color(0.33f, 0.24f, 0.12f, 1f),
                new Color(0.92f, 0.89f, 0.76f, 1f),
                new Color(0.97f, 0.94f, 0.82f, 1f),
                new Color(0.84f, 0.97f, 0.66f, 1f),
                new Color(0.10f, 0.48f, 0.34f, 1f),
                new Color(0.03f, 0.34f, 0.24f, 1f),
                new Color(0.85f, 0.49f, 0.13f, 1f),
                new Color(0.04f, 0.16f, 0.13f, 0.78f),
                new Color(0.07f, 0.32f, 0.23f, 0.95f),
                new Color(0.71f, 0.52f, 0.24f, 0.95f),
                new Color(0.12f, 0.19f, 0.15f, 0.38f),
        ...
        private static GameplayPalette RoyalPurple()
        {
            return new GameplayPalette(
                ...
                new Color(0.10f, 0.06f, 0.17f, 1f),
                new Color(0.10f, 0.06f, 0.17f, 1f),
                new Color(0.88f, 0.82f, 0.68f, 0.94f),
                ...
                new Color(0.13f, 0.07f, 0.20f, 0.78f),
                new Color(0.29f, 0.13f, 0.48f, 0.95f),
                new Color(0.72f, 0.50f, 0.20f, 0.95f),
                new Color(0.17f, 0.12f, 0.22f, 0.40f),
                new Color(0.98f, 0.92f, 0.78f, 1f),
        ...
        private static GameplayPalette PremiumDark()
        {
            return new GameplayPalette(
                ...
                new Color(0.055f, 0.060f, 0.075f, 1f),
                new Color(0.055f, 0.060f, 0.075f, 1f),
                new Color(0.14f, 0.13f, 0.12f, 0.88f),
                new Color(0.66f, 0.43f, 0.18f, 1f),
                new Color(0.31f, 0.18f, 0.07f, 1f),
                new Color(0.91f, 0.84f, 0.67f, 1f),
                new Color(1.00f, 0.95f, 0.78f, 1f),
                new Color(1.00f, 0.84f, 0.36f, 1f),
                new Color(0.98f, 0.67f, 0.24f, 1f),
                new Color(0.08f, 0.34f, 0.70f, 1f),
                new Color(0.93f, 0.42f, 0.10f, 1f),
                new Color(0.09f, 0.10f, 0.12f, 0.76f),
                new Color(0.16f, 0.18f, 0.22f, 0.95f),
                new Color(0.47f, 0.31f, 0.14f, 0.95f),
                new Color(0.16f, 0.16f, 0.18f, 0.38f),
