...
namespace QuixoUnity.Core
{
    ...
    public static class QometGraph
    {
        ...
        private static readonly QometNode[] Nodes =
        {
            ...
            new("J", 3, 0, new Vector2(-3f, 0f), new Vector2(-6f, 0f)),
            new("K", 3, 1, new Vector2(-2f, 0f), new Vector2(-4f, 0f)),
            new("L", 3, 2, new Vector2(-1f, 0f), new Vector2(-2f, 0f)),
            new("M", 3, 3, new Vector2(0f, 0f), new Vector2(0f, 0f)),
            new("N", 3, 4, new Vector2(1f, 0f), new Vector2(2f, 0f)),
            new("O", 3, 5, new Vector2(2f, 0f), new Vector2(4f, 0f)),
            new("P", 3, 6, new Vector2(3f, 0f), new Vector2(6f, 0f)),
